  ...
  <div class="container">
    ...
    <div class="sec-heading text-center">
      <div class="sub-inner mb-52">
        <img class="heading-right-image" src="{{ asset('assets/images/icons/steps2.png') }}" alt="Steps-Image" />
        <span class="sub-title white-color">Urmărește-ne pe social media</span>
        <img class="heading-left-image" src="{{ asset('assets/images/icons/steps.png') }}" alt="Steps-Image" />
      </div>
    </div>
    ...
    <div class="footer-mainmenu text-center mb-20">
      <ul>
        <li><a href="{{ route('concurs') }}">Concurs zilnic</a></li>
        <li><a href="{{ route('arena.trivia.joaca-trivia') }}">Trivia Arena</a></li>
        <li><a href="{{ route('arena.misiuni.index') }}">Misiuni & Provocări</a></li>
    ...
    <!-- Copyright -->
        ...
        <p class="dsc mb-37">
            ...
            <a target="_blank" class="gafi" href="{{ route('home') }}">AuditiePlacuta.ro</a> |
