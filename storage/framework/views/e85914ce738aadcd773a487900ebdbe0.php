                ...
                <div class="col">
                    <div class="p-3 rounded bg-dark text-white border border-info text-center h-100 d-flex flex-column justify-content-between">
                        ...
                        <div>
                            ...
                            <small class="text-light-emphasis"><?php echo e($ability->description); ?></small><br>
                            <small class="text-light-emphasis">⏱ Cooldown: <?php echo e($ability->cooldown); ?>h</small>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\auditieplacuta\resources\views\user\abilities.blade.php ENDPATH**/ ?>