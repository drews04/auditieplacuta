...
.gamfi-tokenomics-section .tokenomics-left-right-shape::before, .gamfi-tokenomics-section .tokenomics-left-right-shape::after {
  height: 40px;
  width: 604px;
  content: " ";
  position: absolute;
...
.gamfi-partner-section .gamfi-partner-inner::after, .gamfi-partner-section .gamfi-partner-inner::before {
  content: "";
  display: block;
  width: 50px;
  height: 100%;
...
.faq_content_sect .faq_questions .accordion.active, .faq_content_sect .faq_questions .accordion:hover {
  background: rgba(255, 255, 255, 0.05);
  color: #FFFFFF;
}
...
.gamfi_Home4_footer_section, .gamfi_Home4_footer_section .HomeV4_FooterArea {
  background: transparent;
}
...
.live_project_headings::before, .live_project_headings::after {
  box-sizing: border-box;
}
...
.project-details-conent .project-item .date-listing li:hover button, .project-details-conent .project-item .date-listing li.active button {
  background: #303244;
  color: #A3FF12;
}
...
.project-menu-area .al-access-menu > li::before, .project-menu-area .al-access-menu > li::after {
  content: "\e901";
  position: absolute;
  top: 26px;
  right: 28px;
...
.project_clasic_slider_sect .project_clasic_prev, .project_clasic_next {
  cursor: pointer;
  position: absolute;
  top: 50%;
  width: auto;
...
.project_clasic_slider_sect .active, .dot:hover {
...
.project_summary_tabs_sect .project-summary-tab-btn.active a, .project_summary_tabs_sect .project-summary-tab-btn:hover a {
  color: #A3FF12;
}
...
.project_summary_tabs_sect .project-summary-tab-btn.active img, .project_summary_tabs_sect .project-summary-tab-btn:hover img {
  display: block;
}
...
.calendar header .simple-calendar-btn::before, .calendar header .simple-calendar-btn::after {
  display: none;
}
...
.scmenu-main .menu_column {
  padding: 0 0.75rem;
}

.scmenu-main .menu_column > a {
  font-size: 1.2rem;
  margin-right: 1rem;
  transition: color 0.2s ease, text-decoration 0.2s ease;
}

.scmenu-main .menu_column > a:hover {
  color: #e63946;
  text-decoration: underline;
}

.scmenu-main .menu_column ul li {
